<template>
  ...
  <section class="main__page-block page-block">
      ...
      <div class="slider-page__swiper">
        <div class="slider-page__slide slide-slider-page">
          ...
          <p>
            ...
            elementum risus scelerisque nec interdum sit risus. Pharetra turpis
            interdum ut at lacinia. Tincidunt ullamcorper pulvinar tellus tellus
            at. Sed venenatis, lectus nunc consectetur pellentesque venenatis.
          </p>
  ...
  <section class="main__can-contant contant-can">
